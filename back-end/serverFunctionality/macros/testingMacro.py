...
class macro:
    ...
    def callMacro(self, file, id, offsetX=0, offsetY=0):
        print("this is the file = ", file, id, offsetX, offsetY)
        ij = imagej.init('~/necessary/Fiji.app', headless=False)
...
"""
	...
	var tileConfig = "dim = 3\\n";	
        ...
        saving = f"""
		saveAs("tiff", "/home/giovanni/Documents/pyimagej-flask-server/static/result-{id}");
		run("Z Project...", "projection=[Max Intensity]");
		saveAs("Jpeg", "/home/giovanni/Documents/pyimagej-flask-server/static/result-{id}");
		close();
		close();
		"""
...
# macros = macro()
# macros.callMacro("/media/biology-share/IMAGEJ_SERVER/Pending/6wk_MATl_Occludin_GFAP_DAPI_4xMAT_0002/",1, 0, 0)
# import time
# time.sleep(10)
# macros.callMacro("/media/biology-share/Kole/Kole_MultiTime_Lapse/6wk_MATl_Occludin_GFAP_DAPI_4xMAT_0002/", 1, 0, 0)
